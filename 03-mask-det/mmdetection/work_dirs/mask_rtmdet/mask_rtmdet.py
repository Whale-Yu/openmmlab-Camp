...
log_level = 'INFO'
load_from = 'work_dirs/mask_rtmdet/best_coco_bbox_mAP_epoch_70.pth'
resume = False
train_cfg = dict(
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file='mask_dataset/val.json',
    metric='bbox',
    format_only=False,
    backend_args=None,
...
metainfo = dict(
    classes=('no_mask', 'mask'), palette=[(220, 20, 60), (20, 20, 200)])
num_classes = 2
...
num_epochs_stage2 = 5
launcher = 'none'
work_dir = './work_dirs/mask_rtmdet'
